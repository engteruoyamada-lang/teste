...
BANDAS_INFO = {
    ...
    "B07": {"nome": "IR Onda Curta (3,9µm)", "icon": "🔥", "uso": "Focos de incêndio em tempo quase real, nevoeiro matinal", "cmap": "hot", "cor_card": "#bf360c"},
    ...
    "B14": {"nome": "IR Longo – QPE (11,2µm)", "icon": "🌧️", "uso": "Estimativa de precipitação (QPE) — mm de chuva estimados", "cmap": "Blues", "cor_card": "#0277bd"},
}
